...
val guardAsleepMost = grid.map(entry => entry._1 -> entry._2.map(_._2).sum).maxBy(_._2)._1
val minuteAsleepMost = grid(guardAsleepMost).maxBy(_._2)
minuteAsleepMost._1 * guardAsleepMost.toInt
